...
3. Read the [Quickstart Guide](quickstart.md) guide to learn how to retrieve all works (including works by id) and how to add a new work (movie) and its location.
